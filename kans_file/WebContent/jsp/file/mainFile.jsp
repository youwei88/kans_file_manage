...
<body>
	...
	<div class="easyui-layout" style="width:1700px;height:840px;">
		<div region="west" split="true" title="目录导航" style="width:400px;">
			...
			<span>&nbsp;目录不存在编码共</span><span style="color: red;">${noMatchListSize}</span><span>个:</span><span id="noMatchList">${noMatchList}</span><br />
<%--		<span>&nbsp;格式有误单号共</span><span style="color: red;">${noMatchCommandSize}</span><span>个:</span><span id="sapList">${noMatchCommands}</span><br />
 			<span>&nbsp;未创建目录单号共</span><span style="color: red;">${dbNoMatchSize}</span><span>个:</span><span id="sapList">${dbNoMatchCommands}</span><br /> --%>
			<div id="showDiv">
