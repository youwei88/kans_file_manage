...
<body id="b">
	...
	<div id="addDiv" class="easyui-dialog" modal="true"
		data-options="title:'增加一级目录',closable:true,closed:true,buttons:[{text:'确定',handler:function(){submitButton('addDiv','addForm')}},{text:'关闭',handler:function(){$('#addDiv').dialog('close')}}]">
		<form id="addForm" action="<%=base%>/dir/addDir" method="post">
			<table>
				<tr>
					<td>目录名：</td>
					<td>
			 ...
			 $('#dg').datagrid({
			        ...
			        columns: [  
			            [  
			                ...
			                {field: 'title', title: '目录', width: 180, align: "center"},
			                {field: 'type', title: '级别', width: 180, align: "center",formatter : function(value,row,index){
			                    if(value=='3') {
		                    		return '一级'
		                    	} else if(value=='4'){
		                    		return '二级'
			                ...
			                {field: 'displayParentName', title: '父目录', width: 180, align: "center"},
